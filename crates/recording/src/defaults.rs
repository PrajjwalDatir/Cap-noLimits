...
pub const FREE_INSTANT_MODE_MAX_RESOLUTION: u32 = 3840;
pub const PRO_INSTANT_MODE_MAX_RESOLUTION: u32 = 3840;
pub const DEFAULT_INSTANT_MODE_MAX_RESOLUTION: u32 = 1920;
